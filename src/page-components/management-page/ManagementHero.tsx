...
import managementPageLottiei from "../../../src/lottie/management.json";
...
const ManagementHero = () => {
  ...
  const defaultOptions = {
    loop: true,
    autoplay: true,
    animationData: managementPageLottiei,
        ...
        <Grid item md={7} sm={6} xs={12}>
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                Video Management made easy for your Shopify webstore.
              </Typography>
            </motion.div>
            ...
            >
              Effortlessly plan and schedule your video campaigns on your
              Shopify store. Use real-time analytics to see the impact. Give
              shoppers a unified brand presence with social sharing.
            </Typography>
