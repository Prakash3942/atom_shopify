...
import bannerPageLottiei from "../../../src/lottie/bannerLottie.json";
...
const BannerHeroSection = () => {
  ...
  const defaultOptions = {
    loop: true,
    autoplay: true,
    animationData: bannerPageLottiei,
        ...
        <Grid item md={7} sm={6} xs={12}>
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                Make a complete impact with wide-screen Shoppable Banners.
              </Typography>
            </motion.div>
            ...
            >
              Capture your audience’s complete attention by showcasing your
              product and brand in 1080x720 wide shoppable videos.
            </Typography>
