...
import productPageLottiei from "../../../src/lottie/productLottie.json";
...
const ProductHeroSection = () => {
  ...
  const defaultOptions = {
    loop: true,
    autoplay: true,
    animationData: productPageLottiei,
        ...
        <Grid item md={7} sm={6} xs={12}>
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                Elevate your products with Product View360 and speak louder than
                words.
              </Typography>
            </motion.div>
            ...
            >
              Breathe life into your products with videos that convert. Say
              goodbye to static images and hello to a dynamic product pages that
              make video shopping a delight.
            </Typography>
