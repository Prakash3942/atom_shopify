...
import sectionPageLottiei from "../../../src/lottie/sections.json";
...
const SectionHero = () => {
  ...
  const defaultOptions = {
    loop: true,
    autoplay: true,
    animationData: sectionPageLottiei,
        ...
        <Grid item md={7} sm={6} xs={12}>
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                Showcase your products with Multi-Video Shopping.
              </Typography>
            </motion.div>
            ...
            >
              Breakdown your product into multiple features and highlight it
              over your home page and product page using Product Highlights.
            </Typography>
